  ...
  return (
              ...
              <div className="col-xl-12">
                <div className="relative_contect d-flex">
                  ...
                  <ul className="wsus_menu_cat_item show_home toggle_menu">
                    <li><a href="#"><i className="fas fa-star" /> hot promotions</a></li>
                    <li><a className="wsus__droap_arrow" href="#"><i className="fal fa-tshirt" /> Fashion </a>
                      <ul className="wsus_menu_cat_droapdown">
                        <li><a href="#">New Arrivals <i className="fas fa-angle-right" /></a>
                        ...
                        <li><a href="#">Best Sellers</a></li>
                        <li><a href="#">Trending <i className="fas fa-angle-right" /></a>
                          <ul className="wsus__sub_category">
                            <li><a href="#">New Arrivals</a> </li>
                            <li><a href="#">Best Sellers</a></li>
                            <li><a href="#">Trending</a></li>
                        ...
                        <li><a href="#">TV &amp; Videos</a></li>
                        <li><a href="#">Camera</a></li>
                        <li><a href="#">Photos &amp; Videos <i className="fas fa-angle-right" /></a>
                          <ul className="wsus__sub_category">
                            <li><a href="#">New Arrivals</a> </li>
                            <li><a href="#">Best Sellers</a></li>
                            <li><a href="#">Trending</a></li>
                    ...
                    <li><a className="wsus__droap_arrow" href="#"><i className="fas fa-tv" /> Electronics</a>
                      <ul className="wsus_menu_cat_droapdown">
                        <li><a href="#">New Arrivals <i className="fas fa-angle-right" /></a>
                          <ul className="wsus__sub_category">
                            <li><a href="#">New Arrivals</a> </li>
                    ...
                    <li><a className="wsus__droap_arrow" href="#"><i className="fas fa-chair-office" /> Furniture</a>
                      <ul className="wsus_menu_cat_droapdown">
                        <li><a href="#">New Arrivals <i className="fas fa-angle-right" /></a>
                          <ul className="wsus__sub_category">
                            <li><a href="#">New Arrivals</a> </li>
                    ...
                    <li><a className="wsus__droap_arrow" href="#"><i className="fal fa-mobile" /> Smart Phones</a>
                      <ul className="wsus_menu_cat_droapdown">
                        <li><a href="#">New Arrivals <i className="fas fa-angle-right" /></a>
                          <ul className="wsus__sub_category">
                            <li><a href="#">New Arrivals</a> </li>
                    ...
                    <li><a href="#"><i className="fas fa-home-lg-alt" /> Home &amp; Garden</a></li>
                    <li><a href="#"><i className="far fa-camera" /> Accessories</a></li>
                    <li><a href="#"><i className="fas fa-heartbeat" /> Healthy &amp; Beauty</a></li>
                    <li><a href="#"><i className="fal fa-gift-card" /> Gift Ideas</a></li>
                    <li><a href="#"><i className="fal fa-gamepad-alt" /> Toy &amp; Games</a></li>
                    <li><a href="#"><i className="fal fa-gem" /> View All Categories</a></li>
                  </ul>
                  <ul className="wsus__menu_item">
                    <li><a className="active" href="index.html">home</a></li>
                    <li><a href="product_grid_view.html">shop <i className="fas fa-caret-down" /></a>
                    ...
                    <li className="wsus__relative_li"><a href="#">pages <i className="fas fa-caret-down" /></a>
    ...
    ==============================*/}
        <section id="wsus__mobile_menu">
          <span className="wsus__mobile_menu_close"><i className="fal fa-times" /></span>
          <ul className="wsus__mobile_menu_header_icon d-inline-flex">
            <li><a href="wishlist.html"><i className="far fa-heart" /> <span>2</span></a></li>
            <li><a href="compare.html"><i className="far fa-random" /> <span>3</span></a></li>
          </ul>
          <form>
          ...
          <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li className="nav-item" role="presentation">
              <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Categories</button>
            </li>
            <li className="nav-item" role="presentation">
              <button className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">main menu</button>
            </li>
          </ul>
              ...
              <div className="wsus__mobile_menu_main_menu">
                <div className="accordion accordion-flush" id="accordionFlushExample">
                  <ul className="wsus_mobile_menu_category">
                    <li><a href="#"><i className="fas fa-star" /> hot promotions</a></li>
                    <li><a href="#" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThreew" aria-expanded="false" aria-controls="flush-collapseThreew"><i className="fal fa-tshirt" /> fashion</a>
                      <div id="flush-collapseThreew" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    ...
                    <li><a href="#" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThreer" aria-expanded="false" aria-controls="flush-collapseThreer"><i className="fas fa-tv" /> electronics</a>
                      <div id="flush-collapseThreer" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div className="accordion-body">
                          <ul>
                    ...
                    <li><a href="#" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThreerrp" aria-expanded="false" aria-controls="flush-collapseThreerrp"><i className="fas fa-chair-office" />
                        furnicture</a>
                      <div id="flush-collapseThreerrp" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div className="accordion-body">
                          <ul>
                            <li><a href="#">home</a></li>
                    ...
                    <li><a href="#" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThreerrw" aria-expanded="false" aria-controls="flush-collapseThreerrw"><i className="fal fa-mobile" /> Smart
                        Phones</a>
                      <div id="flush-collapseThreerrw" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div className="accordion-body">
                          <ul>
              ...
              <div className="wsus__mobile_menu_main_menu">
                <div className="accordion accordion-flush" id="accordionFlushExample2">
                  <ul>
                    ...
                    <li><a href="#" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">shop</a>
                    ...
                    <li><a href="blog.html">blog</a></li>
                    <li><a href="daily_deals.html">campain</a></li>
                    <li><a href="#" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree101" aria-expanded="false" aria-controls="flush-collapseThree101">pages</a>
                      <div id="flush-collapseThree101" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample2">
                        <div className="accordion-body">
                          <ul>
                            <li><a href="404.html">404</a></li>
                            <li><a href="faqs.html">faq</a></li>
                  ...
                  <div className="row">
                    <div className="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
                      <div className="wsus__quick_view_img">
                        <a className="venobox wsus__pro_det_video" data-autoplay="true" data-vbtype="video" href="https://youtu.be/7m16dFI1AF8">
                          <i className="fas fa-play" />
                        </a>
                        <div className="row modal_slider">
                          <div className="col-xl-12">
                            <div className="modal_slider_img">
                              <img src="images/zoom1.jpg" alt="product" className="img-fluid w-100" />
                            </div>
                          </div>
                          <div className="col-xl-12">
                            <div className="modal_slider_img">
                              <img src="images/zoom2.jpg" alt="product" className="img-fluid w-100" />
                            </div>
                          </div>
                          <div className="col-xl-12">
                            <div className="modal_slider_img">
                              <img src="images/zoom3.jpg" alt="product" className="img-fluid w-100" />
                            </div>
                          </div>
                          <div className="col-xl-12">
                            <div className="modal_slider_img">
                              <img src="images/zoom4.jpg" alt="product" className="img-fluid w-100" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                      <div className="wsus__pro_details_text">
                        <a className="title" href="#">Electronics Black Wrist Watch</a>
                        <p className="wsus__stock_area"><span className="in_stock">in stock</span> (167 item)</p>
                        ...
                        <div className="wsus_pro_det_color">
                          <h5>color :</h5>
                          <ul>
                            <li><a className="blue" href="#"><i className="far fa-check" /></a></li>
                            <li><a className="orange" href="#"><i className="far fa-check" /></a></li>
                            <li><a className="yellow" href="#"><i className="far fa-check" /></a></li>
                            <li><a className="black" href="#"><i className="far fa-check" /></a></li>
                            <li><a className="red" href="#"><i className="far fa-check" /></a></li>
                          </ul>
                        </div>
                        ...
                        <div className="wsus__quentity">
                          ...
                          <form className="select_number">
                            <input className="number_area" type="text" min={1} max={100} defaultValue={1} />
                          </form>
                          <h3>$50.00</h3>
                        </div>
                        ...
                        <ul className="wsus__button_area">
                          ...
                          <li><a className="buy_now" href="#">buy now</a></li>
                          <li><a href="#"><i className="fal fa-heart" /></a></li>
                          <li><a href="#"><i className="far fa-random" /></a></li>
                        </ul>
                        <p className="brand_model"><span>model :</span> 12345670</p>
                        <p className="brand_model"><span>brand :</span> The Northland</p>
    ...
    ==============================*/}
              ...
              <div className="col-xl-12">
                <div className="wsus__banner_content">
                  <div className="row banner_slider">
                    <div className="col-xl-12">
                      <div className="wsus__single_slider" style={{background: 'url(images/slider_1.jpg)'}}>
                    ...
                    <div className="col-xl-12">
                      <div className="wsus__single_slider" style={{background: 'url(images/slider_2.jpg)'}}>
                        <div className="wsus__single_slider_text">
                          <h3>new arrivals</h3>
                          <h1>kid's fashion</h1>
                    ...
                    <div className="col-xl-12">
                      <div className="wsus__single_slider" style={{background: 'url(images/slider_3.jpg)'}}>
                        <div className="wsus__single_slider_text">
                          <h3>new arrivals</h3>
        ...
        <section id="wsus__flash_sell" className="wsus__flash_sell_2">
          <div className=" container">
            <div className="row">
              <div className="col-xl-12">
                <div className="offer_time" style={{background: 'url(images/flash_sell_bg.jpg)'}}>
                  <div className="wsus__flash_coundown">
                    <span className=" end_text">flash sell</span>
                    <div className="simply-countdown simply-countdown-one" />
                    <a className="common_btn" href="#">see more <i className="fas fa-caret-right" /></a>
                  </div>
                </div>
              </div>
            </div>
            <div className="row flash_sell_slider">
            {
              listProds.length > 0 ? 
                    ...
                    listProds.map(product => <ProductCard productDetails= {product} />) : <SpinTip />
                }
            </div>
          </div>
        </section>
